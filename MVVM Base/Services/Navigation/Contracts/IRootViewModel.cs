...
namespace MVVM_Base.Services.Navigation.Contracts
{
    ...
    /// <see cref="MVVM_Base.Services.Navigation.NavigationRegistration.AddTab{TRoot}"/> requires
    ...
    public interface IRootViewModel
    {
        ...
        ///
        /// Independent of <see cref="MVVM_Base.ViewModels.ViewModelBase.Name"/>. A root may
